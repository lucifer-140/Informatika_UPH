...
public class Main { 
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Menghitung Luas Segitga");
        ...
        JLabel lblTitle = new JLabel("Menghitung Segita");
        JLabel lblAlas = new JLabel("Alas:");
        JLabel lblTinggi = new JLabel("Tinggi:");
        JTextField txtAlas = new JTextField(15);
        JTextField txtTinggi = new JTextField(15);
        JButton btnHitung = new JButton("Hitung");
        JLabel lblHasil = new JLabel("Hasil:");

        lblTitle.setBounds(130, 20, 200, 25);
        lblAlas.setBounds(50, 70, 80, 25);
        txtAlas.setBounds(140, 70, 200, 25);
        lblTinggi.setBounds(50, 110, 80, 25);
        txtTinggi.setBounds(140, 110, 200, 25);
        ...
        btnHitung.addActionListener(e -> {
            try {
                ...
                hitung.setalas(Integer.parseInt(txtAlas.getText()));
